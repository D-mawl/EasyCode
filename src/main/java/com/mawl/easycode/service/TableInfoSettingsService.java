...
import com.mawl.easycode.dto.TableInfoSettingsDTO;
import com.mawl.easycode.entity.TableInfo;
import com.mawl.easycode.service.impl.TableInfoSettingsServiceImpl;
    ...
    static TableInfoSettingsService getInstance() {
        try {
            ...
            if (workspaceFile != null) {
                VirtualFile configFile = workspaceFile.getParent().findChild("easyCode2026TableSetting.xml");
